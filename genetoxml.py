...
def main():
    ...
    # get the last modified time for server
    # the return would be '213 20120101051112'
	...
	f.close()
        ...
        subprocess.call('linux.gene2xml -i %s -o %s -c -b' % (storeFile, outFile),
			shell=True)
